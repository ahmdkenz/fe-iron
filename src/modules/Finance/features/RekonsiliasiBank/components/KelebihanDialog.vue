      ...
      >
        <div class="d-flex flex-wrap gap-4 align-center rounded-lg pa-3 mb-4 bg-error-subtle">
          ...
          <div>
            ...
            <div class="text-body-2 font-weight-semibold">
              {{ formatCurrency(item?.kelebihan_bayar?.total ?? 0) }}
            </div>
          </div>
          <VDivider
            vertical
          ...
          <div>
            ...
            <div class="text-body-2">
              {{ formatCurrency(item?.kelebihan_bayar?.sudah_dialokasi ?? 0) }}
            </div>
          </div>
          <VDivider
            vertical
          ...
          <div>
            ...
            <div class="text-body-2 font-weight-bold text-error">
              {{ formatCurrency(item?.kelebihan_bayar?.sisa ?? 0) }}
            </div>
          </div>
        </div>
        ...
        />
        <VAlert
          v-if="!invoiceB2CLoading && invoiceB2CList.length === 0"
          type="info"
          variant="tonal"
          density="compact"
          class="mb-3"
          ...
          >
            ...
            >
              ...
              <div class="flex-1-1 min-width-0">
                ...
                <div
                  v-if="inv.nama_resto || inv.nama_klien"
        ...
        />
        <VAlert
          v-if="!invoiceB2BLoading && invoiceB2BList.length === 0"
          type="info"
          variant="tonal"
          density="compact"
          class="mb-3"
        ...
        <template v-if="item?.kelebihan_bayar">
          ...
          >
            ...
            <div class="flex-1-1">
              <div class="text-body-2 font-weight-semibold text-deep-purple">
                PDM TERCATAT
              </div>
              <div class="text-caption text-medium-emphasis">
