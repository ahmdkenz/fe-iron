                ...
                <tbody>
                  ...
                  >
                    ...
                    <td
                      ...
                      :class="isOverdue(inv) ? 'text-error font-weight-medium' : 'text-medium-emphasis'"
                    >
                      {{ formatDate(inv.tanggal_jatuh_tempo) }}
                    </td>
                    <td class="text-end text-no-wrap">
                      {{ formatRp(inv.subtotal) }}
                    </td>
                    <td class="text-end text-no-wrap text-success">
                      {{ formatRp(inv.total_pembayaran) }}
                    </td>
                    <td
                      class="text-end text-no-wrap font-weight-bold"
                      :class="sisaPerInvoice(inv) > 0 ? 'text-warning' : 'text-success'"
                    >
              ...
              >
                ...
                <tbody>
                  <tr
                    v-for="p in payments"
                    :key="p.id"
                    :class="p.jenis === 'ALO_CROSS' ? 'bg-surface-variant' : ''"
                  >
                    <td class="font-weight-medium text-no-wrap">
                      {{ p.no_invoice }}
                    </td>
                    ...
                    <td
                      class="text-end text-no-wrap font-weight-bold"
                      :class="p.jenis === 'ALO_CROSS' ? 'text-medium-emphasis' : 'text-success'"
                    >
                    ...
                    <td>
                      ...
                      <VTooltip
                        v-else-if="p.jenis === 'ALO_CROSS'"
                        :text="`Dialokasikan ke: ${p.nama_klien_tujuan}`"
                      >
