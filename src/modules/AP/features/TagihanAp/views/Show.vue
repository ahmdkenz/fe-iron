          ...
          <VCard>
            <VCardTitle class="pa-4 pb-2 d-flex align-center justify-space-between">
              ...
              <div class="d-flex gap-2">
                <VChip
                  v-if="tagihan.source_system === 'SHZ360'"
                  color="info"
                  size="small"
                  variant="tonal"
              ...
              <VRow>
                ...
                >
                  <DetailRow
                    ...
                    :value="tagihan.no_invoice_vendor"
                  />
                </VCol>
                <VCol
                  cols="12"
                ...
                >
                  <DetailRow
                    label="No. Terima Barang"
                    :value="tagihan.no_terima_barang"
                  />
                </VCol>
                <VCol
                  cols="12"
              ...
              <table class="summary-table w-100">
                <tr>
                  ...
                  <td class="text-body-2 text-right font-weight-medium pb-2">
                    {{ formatCurrency(tagihan.subtotal) }}
                  </td>
                </tr>
                <tr>
                  <td class="text-body-2 text-medium-emphasis pb-2">
                  ...
                  <td class="text-body-2 text-right font-weight-medium pb-2">
                    {{ formatCurrency(tagihan.ppn_masukan) }}
                  </td>
                </tr>
                <tr>
                  <td class="text-body-2 text-medium-emphasis pb-2">
