      ...
      <VWindowItem value="finance">
        ...
        >
          ...
          <template v-else>
            ...
            >
              <template #prepend>
                <VAvatar :color="meta(item.severity).color" variant="tonal" :size="compact ? 30 : 36">
                  <VIcon :icon="meta(item.severity).icon" :size="compact ? 16 : 20" />
                </VAvatar>
              </template>
              ...
              <VListItemSubtitle :class="compact ? 'notification-body--clamp' : 'text-wrap'">
                {{ item.body }}
              </VListItemSubtitle>
              <VListItemSubtitle v-if="!compact" class="text-caption mt-1">
      ...
      <VWindowItem value="updates">
        ...
        >
          ...
          <template v-else>
            ...
            >
              <template #prepend>
                <VAvatar color="primary" variant="tonal" :size="compact ? 30 : 36">
                  <VIcon icon="ri-rocket-2-line" :size="compact ? 16 : 20" />
                </VAvatar>
              </template>
              ...
              <ul v-if="update.items?.length && !compact" class="update-items text-caption text-medium-emphasis">
