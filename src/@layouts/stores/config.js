...
export const useLayoutConfigStore = defineStore('layoutConfig', () => {
  ...
  const overlayNavMediaQuery = useMediaQuery(`(max-width: ${layoutConfig.app.overlayNavFromBreakpoint}px)`)
  ...
  watch(overlayNavMediaQuery, val => {
  ...
  const _layoutClasses = computed(() => {
    return [
      ...
      { 'window-scrolled': isScrolled.value },
